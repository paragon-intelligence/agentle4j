 ...
 * {@link PromptProvider} interface. Implementations may persist prompts to databases, file systems,
...
public interface PromptStore {
   ...
   *
   * <p>Convenience method that creates a {@link Prompt} from the content string. If a prompt with
