 ...
 * </ul>
 *
 * <p>Without this serializer, Jackson would serialize {@code output} as a nested JSON object (e.g.,
 * {@code {"text": "..."}}) because {@code FunctionToolCallOutputKind} has no type information. That
 * causes OpenRouter (and OpenAI) to reject the payload with {@code "expected string, received
 * object"}.
 */
