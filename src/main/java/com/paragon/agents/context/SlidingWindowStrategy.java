 ...
 * </ul>
 *
 * <p>This is the simplest and most efficient context management strategy, suitable for most use
...
public final class SlidingWindowStrategy implements ContextWindowStrategy {
   ...
   *
   * <p>By default, all messages including developer messages may be removed when the context limit
   * is exceeded.
   */
   ...
   *
   * @param preserveDeveloperMessages if true, developer messages at the start of the conversation
   ...
   *
   * <p>The developer message (system prompt) at the start of the conversation will be preserved
