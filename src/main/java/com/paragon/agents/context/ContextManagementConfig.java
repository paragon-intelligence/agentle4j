 ...
 *
 * <p>This class encapsulates all settings for managing conversation context length, including the
...
public final class ContextManagementConfig {
  ...
  private ContextManagementConfig(Builder builder) {
    ...
    this.tokenCounter =
        builder.tokenCounter != null ? builder.tokenCounter : new SimpleTokenCounter();
  }
  ...
  public static final class Builder {
     ...
     *
     * <p>When context exceeds this limit, the strategy will be applied to reduce it.
     *
