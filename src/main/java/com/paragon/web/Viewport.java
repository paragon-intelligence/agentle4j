...
public record Viewport(
    @JsonProperty("width") @JsonPropertyDescription("The width of the viewport in pixels")
        int width,
    @JsonProperty("height") @JsonPropertyDescription("The height of the viewport in pixels")
        int height) {
