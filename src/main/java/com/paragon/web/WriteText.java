 ...
 *
 * <p>Note: You must first focus the element using a 'click' action before writing.
 * The text will be typed character by character to simulate keyboard input.
 *
 * @param text Text to write into the element
 */
public record WriteText(
    @JsonProperty("text")
    @JsonPropertyDescription("Text to write into the element.")
    @NonNull String text)
    implements Action {
