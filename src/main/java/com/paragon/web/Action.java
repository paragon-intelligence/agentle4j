 ...
 *
 * <p>Actions are polymorphically serialized using the "type" property as the discriminator. Each
 * action type can be deserialized from JSON based on its type value.
 */
