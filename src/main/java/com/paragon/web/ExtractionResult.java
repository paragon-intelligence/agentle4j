...
public class ExtractionResult {
  ...
  public static final class Structured<T> extends ExtractionResult {
    ...
    public boolean equals(Object o) {
      ...
      return Objects.equals(output, that.output) && Objects.equals(outputType, that.outputType);
    }
  ...
  public record ExtractionError(
    ...
    public static @NonNull ExtractionError navigation(
        @NonNull URI url, @NonNull String message, @Nullable Throwable cause) {
      return new ExtractionError(url, ErrorType.NAVIGATION, message, cause);
    }

    public static @NonNull ExtractionError timeout(
        @NonNull URI url, @NonNull String message, @Nullable Throwable cause) {
      return new ExtractionError(url, ErrorType.TIMEOUT, message, cause);
    }

    public static @NonNull ExtractionError parsing(
        @NonNull URI url, @NonNull String message, @Nullable Throwable cause) {
      return new ExtractionError(url, ErrorType.PARSING, message, cause);
    }

    public static @NonNull ExtractionError llm(
        @NonNull URI url, @NonNull String message, @Nullable Throwable cause) {
