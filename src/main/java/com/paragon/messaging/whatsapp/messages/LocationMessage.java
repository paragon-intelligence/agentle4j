...
public record LocationMessage(
    ...
    Optional<@Size(max = 512, message = "Location address cannot exceed 512 characters") String>
        address)
   ...
   *
   * <p>Usa a fórmula de Haversine para cálculo de distância sobre a esfera terrestre.
   *
  ...
  public static class Builder {
    ...
    public LocationMessage build() {
      return new LocationMessage(
          latitude, longitude, Optional.ofNullable(name), Optional.ofNullable(address));
    }
  }
}
