 ...
 *
 * <p>Handles uploading audio, images, videos, and documents to WhatsApp's media endpoint
 * and returns media IDs that can be used in message sending.</p>
 *
 * <p><b>Virtual Thread Friendly:</b> Uses synchronous OkHttp calls which work well
 * with virtual threads. All I/O operations are blocking but non-blocking at the
 * platform thread level.</p>
 *
 * <h2>Usage Example</h2>
 * <pre>{@code
...
public class WhatsAppMediaUploader {
     ...
     *
     * <p>WhatsApp supports the following audio formats:</p>
     * <ul>
     *   <li>AAC - audio/aac</li>
     *   <li>AMR - audio/amr</li>
     *   <li>MP3 - audio/mpeg</li>
     *   <li>MP4 Audio - audio/mp4</li>
     *   <li>OGG Opus - audio/ogg (recommended for TTS)</li>
     * </ul>
     *
    ...
    public @NonNull MediaUploadResponse uploadAudio(
            ...
            @NonNull String mimeType) throws MediaUploadException {
        ...
        if (audioBytes.length > MAX_AUDIO_SIZE_BYTES) {
            throw new MediaUploadException(
                    "Audio file too large: " + audioBytes.length + " bytes (max " + MAX_AUDIO_SIZE_BYTES + ")"
            );
        }
    ...
    public @NonNull MediaUploadResponse uploadImage(
        ...
        if (imageBytes.length > MAX_IMAGE_SIZE_BYTES) {
            throw new MediaUploadException(
                    "Image file too large: " + imageBytes.length + " bytes (max " + MAX_IMAGE_SIZE_BYTES + ")"
            );
        }
    ...
    private MediaUploadResponse uploadMedia(
            ...
            String mimeType,
            String type,
            String extension) throws MediaUploadException {
    ...
    private MediaUploadResponse parseUploadResponse(Response response) throws MediaUploadException {
        ...
        if (statusCode >= 200 && statusCode < 300) {
            ...
            throw new MediaUploadException(
                    "Media upload failed with status " + statusCode + ": " + body,
                    statusCode
            );
        }
    }
