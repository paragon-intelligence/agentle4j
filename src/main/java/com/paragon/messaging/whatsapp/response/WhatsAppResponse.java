 ...
 *
 * <p>Implement this interface in your structured output types to enable automatic
 * conversion to WhatsApp messages with support for reactions, replies, and
 * multiple message types.</p>
 *
 * <h2>Features</h2>
 * <ul>
 *   <li>Convert structured output to one or more WhatsApp messages</li>
 *   <li>Support for reactions (emoji response to user message)</li>
 *   <li>Support for reply context (quote user message)</li>
 *   <li>Support for multiple message types (text, buttons, lists, media)</li>
 * </ul>
 *
 * <h2>Usage Example</h2>
 * <pre>{@code
 ...
 * @since 2.1
 * @see ResponseContext
 * @see com.paragon.messaging.whatsapp.AIAgentProcessor
 */
public interface WhatsAppResponse {
     ...
     *
     * <p>The returned messages are sent in order. For most responses,
     * a single message is sufficient. Multiple messages can be used for:</p>
     * <ul>
     *   <li>Sending text followed by an image</li>
     *   <li>Sending multiple media items</li>
     *   <li>Sending a message then buttons</li>
     * </ul>
     *
     ...
     *   <li>TTS synthesis (if enabled)</li>
     ...
     *
     * <p>When set, a reaction message is sent before the main response.
     * The reaction is sent to the message specified by {@link #getReactToMessageId()}.</p>
     *
     ...
     *
     * <p>Required when {@link #getReactionEmoji()} returns non-null.</p>
     *
     ...
     *
     * <p>When set, the response messages will appear as replies/quotes
     * to the specified message in the WhatsApp client.</p>
     *
     ...
     *
     * <p>The context provides additional metadata about how the response
     * should be sent. If this returns non-null, the individual getters
     * (getReactionEmoji, getReplyToMessageId, etc.) should delegate to it.</p>
     *
