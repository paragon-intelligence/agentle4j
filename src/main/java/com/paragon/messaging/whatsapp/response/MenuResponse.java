 ...
 *
 * <p>Represents an interactive list message with sections and selectable items. Maximum 10 total
...
public record MenuResponse(
  ...
  public @NonNull List<OutboundMessage> toMessages() {
    InteractiveMessage.ListMessage.Builder builder =
        InteractiveMessage.ListMessage.builder().body(body).buttonText(buttonText);
   ...
   */
  public record Section(@Nullable String title, @NonNull List<MenuItem> items) {
    public Section {
   ...
   */
  public record MenuItem(@NonNull String id, @NonNull String title, @Nullable String description) {
    public MenuItem {
  ...
  public static final class Builder {
    ...
    public Builder addItem(
        @NonNull String id, @NonNull String title, @Nullable String description) {
