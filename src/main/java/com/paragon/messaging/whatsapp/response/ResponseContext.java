 ...
 *
 * <p>Provides additional context for how responses should be sent, including:
 *
 * <ul>
 *   <li>Reply context (quote a specific message)
 *   <li>Reactions (send an emoji reaction)
 *   <li>URL preview settings
...
public record ResponseContext(
   ...
   *
   * <p>URL preview is enabled by default.
   *
   ...
   *
   * <p>The response will appear as a quoted reply in WhatsApp.
   *
   ...
   *
   * <p>The reaction is sent as a separate message before the main response.
   *
  ...
  public boolean hasReaction() {
    return reactionEmoji != null
        && !reactionEmoji.isBlank()
        && reactToMessageId != null
        && !reactToMessageId.isBlank();
  }
  ...
  public static final class Builder {
     ...
     *
     * <p>When set, a typing indicator will be shown for this duration before the response is sent.
     *
    ...
    public ResponseContext build() {
      ...
      return new ResponseContext(
          replyToMessageId, reactionEmoji, effectiveReactTo, previewUrl, typingIndicator);
    }
  }
}
