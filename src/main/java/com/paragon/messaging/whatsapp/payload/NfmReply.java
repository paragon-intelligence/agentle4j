 ...
 *
 * <p>NFM replies are used for flows and forms in WhatsApp Business.
 *
 * <p><b>Note:</b> The {@code responseJson} field contains the actual parsed JSON object returned
 * from a WhatsApp Flow, not a serialized JSON string.
 */
public final class NfmReply implements InteractiveMessage.InteractiveContent {

  public final String type;

  @Nullable public final Map<String, Object> responseJson;
