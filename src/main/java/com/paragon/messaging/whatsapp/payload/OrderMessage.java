 ...
 *
 * <p>Order messages are received when a user places an order through
 * WhatsApp Commerce features.</p>
 */
public final class OrderMessage extends AbstractInboundMessage {
    ...
    public OrderMessage(
        ...
        if (order != null) {
            ...
            this.productItems = order.productItems() != null
                    ? List.copyOf(order.productItems())
                    : List.of();
        } else {
            this.catalogId = null;
            this.text = null;
