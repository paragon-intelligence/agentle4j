 ...
 *
 * <p>System messages include notifications like user identity changes, number changes, or other
 * system events.
 */
public final class SystemMessage extends AbstractInboundMessage {
  ...
  @Nullable public final String identity;

  @Nullable public final String newWaId;

  @Nullable public final String waId;

  @Nullable public final String systemType;

  @Nullable public final String customer;
