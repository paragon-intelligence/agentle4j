 ...
 *
 * <p>Controls whether and how often responses are sent as audio messages instead of text messages.
 *
 * <h2>Usage Example</h2>
 *
 * <pre>{@code
...
public record TTSConfig(
    ...
    @NonNull
        @Pattern(
            regexp = "[a-z]{2}-[A-Z]{2}",
            message = "Language code must be in format 'xx-XX' (e.g., 'pt-BR', 'en-US')")
        String languageCode) {
   ...
   *
   * <p>No audio responses will be generated.
   *
   ...
   *
   * <p>Call this with {@code random.nextDouble()} to determine if audio should be sent.
   *
