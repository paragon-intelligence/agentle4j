 ...
 *
 * <p>Provides persistent conversation history storage using Redis sorted sets. Each user's history
 ...
 *
 * <ul>
 *   <li><b>Key:</b> {@code {keyPrefix}:history:{userId}}
 *   <li><b>Type:</b> Sorted Set (ZSET)
 *   <li><b>Score:</b> Message timestamp (epoch milliseconds)
 *   <li><b>Value:</b> JSON-serialized message
 * </ul>
 *
 * <h2>Features</h2>
 *
 * <ul>
 *   <li>Persistent storage across application restarts
 *   <li>Automatic TTL-based expiration
 *   <li>Efficient time-range queries using sorted set scores
 *   <li>Configurable key prefix for multi-tenant deployments
 *   <li>Thread-safe (Redis operations are atomic)
 * </ul>
 *
 * <h2>Usage Example</h2>
 *
 ...
 * <h2>Dependencies</h2>
 *
 * <p>This class requires a Redis client. Supported options:
 *
 * <ul>
 *   <li>Lettuce (recommended, included in Spring Boot)
 *   <li>Spring Data Redis (RedisTemplate)
 *   <li>Jedis
 * </ul>
 *
 * @author Agentle Team
...
public final class RedisConversationHistoryStore implements ConversationHistoryStore {
  ...
  private RedisConversationHistoryStore(
    ...
    this.redisOperations =
        Objects.requireNonNull(redisOperations, "redisOperations cannot be null");
   ...
   *
   * <p>Implement this interface to adapt your preferred Redis client:
   *
   * <ul>
   *   <li>Lettuce (recommended)
   *   <li>Spring Data Redis (RedisTemplate)
   *   <li>Jedis
   * </ul>
   *
  ...
  public static final class Builder {
     ...
     *
     * <p>This is required. Implement {@link RedisOperations} to adapt your preferred Redis client.
     *
     ...
     *
     * <p>If not set, a default ObjectMapper with Message type handling will be created.
     *
     ...
     *
     * <p>Default is "conversation". Keys will be formatted as: {@code {prefix}:history:{userId}}
     *
     ...
     *
     * <p>Default is 7 days. This TTL is refreshed each time a message is added to a user's history.
     *
     ...
     *
     * <p>Default is 100. When exceeded, oldest messages are removed.
     *
    ...
    public RedisConversationHistoryStore build() {
      ...
      return new RedisConversationHistoryStore(
          redisOperations, mapper, keyPrefix, defaultTtl, maxMessagesPerUser);
    }
