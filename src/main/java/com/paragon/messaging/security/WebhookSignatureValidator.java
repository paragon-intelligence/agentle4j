 ...
 *
 * <p>WhatsApp webhook requests include an {@code X-Hub-Signature-256} header containing an
 ...
 *
 * <ul>
 *   <li>HMAC-SHA256 signature validation
 *   <li>Constant-time comparison to prevent timing attacks
 *   <li>Support for both hex-encoded and sha256= prefixed signatures
 * </ul>
 *
 * <h2>Usage Example</h2>
 *
...
public final class WebhookSignatureValidator {
   ...
   *
   * <p>If signature validation is disabled in the config, the validator will always return true.
   *
   ...
   *
   * <p>Use for testing or when signature validation is not required.
   *
   ...
   *
   * <p>This method compares two strings character by character, always comparing all characters
