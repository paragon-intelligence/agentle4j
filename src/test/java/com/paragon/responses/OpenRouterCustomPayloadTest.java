...
class OpenRouterCustomPayloadTest {
  ...
  class BuilderTests {
    ...
    void builderSetsUser() {
      OpenRouterCustomPayload payload = OpenRouterCustomPayload.builder().user("user-123").build();
    ...
    void builderSetsSessionId() {
      OpenRouterCustomPayload payload =
          OpenRouterCustomPayload.builder().sessionId("session-abc").build();
    ...
    void builderChains() {
      OpenRouterCustomPayload payload =
          OpenRouterCustomPayload.builder().user("user-123").sessionId("session-abc").build();
  ...
  class IsEmptyTests {
    ...
    void notEmptyWhenUserSet() {
      OpenRouterCustomPayload payload = OpenRouterCustomPayload.builder().user("user").build();
    ...
    void notEmptyWhenSessionIdSet() {
      OpenRouterCustomPayload payload =
          OpenRouterCustomPayload.builder().sessionId("session").build();
