...
class HierarchicalAgentsTest {
  ...
  class BuilderTests {
    ...
    void maxTurns_invalidValue_throws() {
      assertThrows(IllegalArgumentException.class, () -> HierarchicalAgents.builder().maxTurns(0));
    }
  ...
  class DepartmentTests {
    ...
    void departments_returnsUnmodifiableMap() {
      ...
      assertThrows(
          UnsupportedOperationException.class, () -> hierarchy.departments().put("New", null));
    }
  ...
  class DirectRoutingTests {
    ...
    void sendToDepartment_unknownDepartment_throws() {
      ...
      assertThrows(
          IllegalArgumentException.class, () -> hierarchy.sendToDepartment("Unknown", "Task"));
    }
    ...
    void sendToDepartment_nullDepartmentName_throws() {
      ...
      assertThrows(NullPointerException.class, () -> hierarchy.sendToDepartment(null, "Task"));
    }
    ...
    void sendToDepartment_nullTask_throws() {
      ...
      assertThrows(
          NullPointerException.class,
          () -> hierarchy.sendToDepartment("Engineering", (String) null));
    }
  }
}
