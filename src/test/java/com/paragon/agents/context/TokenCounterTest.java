...
class TokenCounterTest {
    ...
    class SimpleTokenCounterTests {
        ...
        void countsImageTokens() {
            assertEquals(SimpleTokenCounter.HIGH_DETAIL_IMAGE_TOKENS,
                counter.countImage(Image.fromUrl(ImageDetail.HIGH, "http://example.com/img.jpg")));
            
            assertEquals(SimpleTokenCounter.LOW_DETAIL_IMAGE_TOKENS,
                counter.countImage(Image.fromUrl(ImageDetail.LOW, "http://example.com/img.jpg")));
            
            assertEquals(SimpleTokenCounter.AUTO_DETAIL_IMAGE_TOKENS,
        ...
        void countsMessageWithMultipleContent() {
            Message msg = Message.user(List.of(
                Text.valueOf("Hello"),
                Image.fromUrl("http://example.com/img.jpg")
            ));
