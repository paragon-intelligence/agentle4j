...
class AgentRunStateTest {
  ...
  class StatusPredicates {
    ...
    void completedStateReportsIsCompleted() {
      AgentRunState state = AgentRunState.completed("TestAgent", context, null, List.of(), 1);
  ...
  class Accessors {
    ...
    void agentNameReturnsName() {
      AgentRunState state = AgentRunState.completed("MyAgent", context, null, List.of(), 1);
    ...
    void currentTurnReturnsTurn() {
      AgentRunState state = AgentRunState.completed("TestAgent", context, null, List.of(), 5);
