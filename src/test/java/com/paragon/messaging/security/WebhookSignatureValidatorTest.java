...
class WebhookSignatureValidatorTest {
    ...
    private static final String SAMPLE_PAYLOAD = "{\"object\":\"whatsapp_business_account\",\"entry\":[]}";
    ...
    class ConstructionTests {
        ...
        void create_withNull_throws() {
            assertThrows(NullPointerException.class, () -> 
                    WebhookSignatureValidator.create((String) null));
        }
        ...
        void create_withBlankSecret_throws() {
            assertThrows(IllegalArgumentException.class, () -> 
                    WebhookSignatureValidator.create("   "));
        }
    ...
    class SignatureValidationTests {
        ...
        void isValid_withNullPayload_throws() {
            ...
            assertThrows(NullPointerException.class, () -> 
                    validator.isValid("sha256=abc123", (String) null));
        }
    ...
    class SignatureComputationTests {
        ...
        void computeSignature_byteArrayMatchesString() {
            ...
            String sigFromBytes = validator.computeSignature(
