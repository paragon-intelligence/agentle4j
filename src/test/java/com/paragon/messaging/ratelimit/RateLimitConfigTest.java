...
class RateLimitConfigTest {
  ...
  class ValidationTests {
    ...
    void bucketCapacity_belowMin_failsValidation() {
      RateLimitConfig config = RateLimitConfig.builder().bucketCapacity(0).build();
    ...
    void maxMessagesInWindow_belowMin_failsValidation() {
      RateLimitConfig config = RateLimitConfig.builder().maxMessagesInWindow(0).build();
    ...
    void maxMessagesInWindow_exceedingMax_failsValidation() {
      RateLimitConfig config = RateLimitConfig.builder().maxMessagesInWindow(10001).build();
    ...
    void slidingWindow_notNull() {
      RateLimitConfig config =
          RateLimitConfig.builder().slidingWindow(Duration.ofSeconds(30)).build();
  ...
  class AccessorTests {
    ...
    void tokensPerMinute_returnsValue() {
      RateLimitConfig config = RateLimitConfig.builder().tokensPerMinute(120).build();
    ...
    void bucketCapacity_returnsValue() {
      RateLimitConfig config = RateLimitConfig.builder().bucketCapacity(25).build();
    ...
    void slidingWindow_returnsValue() {
      ...
      RateLimitConfig config = RateLimitConfig.builder().slidingWindow(window).build();
    ...
    void maxMessagesInWindow_returnsValue() {
      RateLimitConfig config = RateLimitConfig.builder().maxMessagesInWindow(75).build();
