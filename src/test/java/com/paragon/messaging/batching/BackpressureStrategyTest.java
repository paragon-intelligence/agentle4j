...
class BackpressureStrategyTest {
  ...
  class EnumPropertiesTests {
    ...
    void valueOf_returnsCorrectStrategy() {
      assertEquals(BackpressureStrategy.DROP_NEW, BackpressureStrategy.valueOf("DROP_NEW"));
      assertEquals(BackpressureStrategy.DROP_OLDEST, BackpressureStrategy.valueOf("DROP_OLDEST"));
      assertEquals(
          BackpressureStrategy.REJECT_WITH_NOTIFICATION,
          BackpressureStrategy.valueOf("REJECT_WITH_NOTIFICATION"));
      assertEquals(
          BackpressureStrategy.BLOCK_UNTIL_SPACE,
          BackpressureStrategy.valueOf("BLOCK_UNTIL_SPACE"));
      assertEquals(
          BackpressureStrategy.FLUSH_AND_ACCEPT, BackpressureStrategy.valueOf("FLUSH_AND_ACCEPT"));
    }
    ...
    void name_returnsCorrectString() {
      ...
      assertEquals(
          "REJECT_WITH_NOTIFICATION", BackpressureStrategy.REJECT_WITH_NOTIFICATION.name());
