...
class RecipientTest {
    ...
    class FactoryMethodsTests {
        ...
        void ofPhoneNumberNormalizedThrowsOnInvalid() {
            assertThrows(IllegalArgumentException.class, () ->
                    Recipient.ofPhoneNumberNormalized("not-a-phone"));

            assertThrows(IllegalArgumentException.class, () ->
                    Recipient.ofPhoneNumberNormalized("123456"));
        }
    ...
    class RecipientTypeTests {
        ...
        void hasPhoneNumberType() {
            assertEquals(Recipient.RecipientType.PHONE_NUMBER,
                    Recipient.RecipientType.valueOf("PHONE_NUMBER"));
        }

        @Test
        @DisplayName("has USER_ID type")
        void hasUserIdType() {
            assertEquals(Recipient.RecipientType.USER_ID,
                    Recipient.RecipientType.valueOf("USER_ID"));
        }

        @Test
        @DisplayName("has EMAIL type")
        void hasEmailType() {
            assertEquals(Recipient.RecipientType.EMAIL,
                    Recipient.RecipientType.valueOf("EMAIL"));
        }
    }
    ...
    class EdgeCasesTests {
        ...
        void throwsOnEmptyString() {
            assertThrows(IllegalArgumentException.class, () ->
                    Recipient.ofPhoneNumberNormalized(""));
        }
        ...
        void throwsOnMalformedNumber() {
            assertThrows(IllegalArgumentException.class, () ->
                    Recipient.ofPhoneNumberNormalized("abc-def-ghij"));
        }
    }
