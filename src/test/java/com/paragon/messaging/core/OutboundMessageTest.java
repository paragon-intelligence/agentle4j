...
class OutboundMessageTest {
  ...
  class TypeMethodTests {
    ...
    void videoReturnsVideoType() {
      OutboundMessage message =
          new MediaMessage.Video(new MediaMessage.MediaSource.MediaId("media123"));
    ...
    void audioReturnsAudioType() {
      OutboundMessage message =
          new MediaMessage.Audio(new MediaMessage.MediaSource.MediaId("media123"));
    ...
    void extractsCaptionFromImage() {
      OutboundMessage message =
          new MediaMessage.Image(
              new MediaMessage.MediaSource.MediaId("media123"), "Check this out!");
  ...
  class HasTextContentTests {
    ...
    void returnsTrueForImageWithCaption() {
      OutboundMessage message =
          new MediaMessage.Image(new MediaMessage.MediaSource.MediaId("media123"), "Caption");
  ...
  class OutboundMessageTypeTests {
    ...
    void hasTextType() {
      assertEquals(
          OutboundMessage.OutboundMessageType.TEXT,
  ...
  class RealWorldScenariosTests {
    ...
    void createsCustomerGreeting() {
      OutboundMessage message =
          new TextMessage("Welcome to our service! How can we help you today?");
    ...
    void createsReply() {
      TextMessage message =
          new TextMessage("Yes, we're open today until 6 PM")
