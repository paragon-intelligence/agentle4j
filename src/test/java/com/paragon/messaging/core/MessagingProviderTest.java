...
class MessagingProviderTest {
    ...
    class DefaultMethodsTests {
        ...
        void sendInteractiveDelegates() throws MessagingException {
            InteractiveMessage.ButtonMessage buttons = InteractiveMessage.ButtonMessage.builder()
    ...
    class BatchSendingTests {
        ...
        void sendBatchSendsMultipleMessages() throws MessagingException {
            List<OutboundMessage> messages = Arrays.asList(
        ...
        void sendBatchFailsIfAnyFails() {
            ...
            assertThrows(MessagingException.class, () ->
                    provider.sendBatch(recipient, messages)
            );
        }
    ...
    class ErrorHandlingTests {
        ...
        void throwsMessagingException() {
            ...
            assertThrows(MessagingException.class, () ->
                    provider.sendText(recipient, new TextMessage("Test"))
            );
        }
    ...
    private static class TestMessagingProvider implements MessagingProvider {
        ...
        @Override
        public MessageResponse sendMessage(Recipient recipient, OutboundMessage message) throws MessagingException {
