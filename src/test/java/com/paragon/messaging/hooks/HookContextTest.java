...
class HookContextTest {
    ...
    class ConstructionTests {
        ...
        void create_nullUserId_throws() {
            assertThrows(IllegalArgumentException.class, () -> 
                    HookContext.create(null, messages));
            assertThrows(IllegalArgumentException.class, () -> 
                    HookContext.create("", messages));
            assertThrows(IllegalArgumentException.class, () -> 
                    HookContext.create("   ", messages));
        }
        ...
        void create_nullMessages_throws() {
            assertThrows(IllegalArgumentException.class, () -> 
                    HookContext.create("user123", null));
        }
    ...
    class EdgeCaseTests {
        ...
        void singleMessage_valid() {
            List<InboundMessage> single = List.of(
                    MockMessageFactory.createTextMessage("user123", "Only one")
            );
