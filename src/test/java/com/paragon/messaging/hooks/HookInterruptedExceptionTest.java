...
class HookInterruptedExceptionTest {
  ...
  class ConstructionTests {
    ...
    void constructor_reasonAndCode() {
      HookInterruptedException exception =
          new HookInterruptedException("Inappropriate content", "CONTENT_MODERATION");
  ...
  class AccessorTests {
    ...
    void getReasonCode_whenSet_returnsCode() {
      HookInterruptedException exception = new HookInterruptedException("Reason", "ERROR_CODE");
  ...
  class ExceptionBehaviorTests {
    ...
    void preservesMessageInStackTrace() {
      HookInterruptedException exception =
          new HookInterruptedException("Important message", "CODE");
  ...
  class RealWorldUseCasesTests {
    ...
    void contentModerationScenario() {
      HookInterruptedException exception =
          new HookInterruptedException("Spam content detected", "CONTENT_MODERATION");
    ...
    void rateLimitingScenario() {
      HookInterruptedException exception =
          new HookInterruptedException("User exceeded rate limit", "RATE_LIMIT");
    ...
    void validationFailureScenario() {
      HookInterruptedException exception =
          new HookInterruptedException("Invalid message format", "VALIDATION_ERROR");
    ...
    void businessRuleViolationScenario() {
      HookInterruptedException exception =
          new HookInterruptedException("User not allowed in this channel", "ACCESS_DENIED");
  ...
  class ReasonCodePatternsTests {
    ...
    void uppercaseSnakeCaseReasonCodes() {
      HookInterruptedException exception =
          new HookInterruptedException("Error", "CONTENT_MODERATION_SPAM");
