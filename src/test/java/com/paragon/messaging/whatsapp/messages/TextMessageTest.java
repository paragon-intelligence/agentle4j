...
class TextMessageTest {
  ...
  class BuilderTests {
    ...
    void buildsWithAllFields() {
      TextMessage message =
          TextMessage.builder().body("Hello, World!").previewUrl(true).replyTo("wamid.123").build();
    ...
    void enablePreviewUrl() {
      TextMessage message = TextMessage.builder().body("Test").enablePreviewUrl().build();
    ...
    void disablePreviewUrl() {
      TextMessage message = TextMessage.builder().body("Test").disablePreviewUrl().build();
  ...
  class ValidationTests {
    ...
    void validatesBodyLength() {
      ...
      assertFalse(violations.isEmpty());
      assertTrue(violations.stream().anyMatch(v -> v.getMessage().contains("4096")));
    }
