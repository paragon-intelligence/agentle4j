...
class TemplateMessageTest {
  ...
  class ConstructionTests {
    ...
    void createsWithNameAndLanguage() {
      TemplateMessage template = new TemplateMessage("hello_world", "en_US", List.of());
    ...
    void createsWithComponents() {
      TemplateComponent bodyComponent = new TemplateComponent("body", List.of("John", "5"));

      TemplateMessage template =
          new TemplateMessage("order_confirmation", "pt_BR", List.of(bodyComponent));
    ...
    void createsImmutableList() {
      TemplateMessage template =
          new TemplateMessage(
              "test", "en", List.of(new TemplateComponent("header", List.of("param1"))));
  ...
  class BuilderTests {
    ...
    void buildsWithoutComponents() {
      TemplateMessage template =
          TemplateMessage.builder().name("simple_template").language("en").build();
  ...
  class ValidationTests {
    ...
    void rejectsInvalidLanguageCodes() {
      ...
      TemplateMessage invalid3 =
          new TemplateMessage("test", "en-US", List.of()); // dash instead of underscore
    ...
    void validatesComponentsNotNull() {
      assertThrows(NullPointerException.class, () -> new TemplateMessage("test", "en", null));
    }
  }
  ...
  class TemplateComponentTests {
    ...
    void createsComponent() {
      TemplateComponent component = new TemplateComponent("body", List.of("param1", "param2"));
    ...
    void createsImmutableParameters() {
      TemplateComponent component = new TemplateComponent("body", List.of("param1"));

      assertThrows(UnsupportedOperationException.class, () -> component.parameters().add("param2"));
    }
    ...
    void validatesParametersNotNull() {
      assertThrows(NullPointerException.class, () -> new TemplateComponent("body", null));
    }
  ...
  class EdgeCasesTests {
    ...
    void handlesManyComponents() {
      TemplateMessage.Builder builder =
          TemplateMessage.builder().name("complex_template").language("en");
