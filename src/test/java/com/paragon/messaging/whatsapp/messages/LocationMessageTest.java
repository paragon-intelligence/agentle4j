...
class LocationMessageTest {
  ...
  class BuilderTests {
    ...
    void buildsWithCoordinatesMethod() {
      LocationMessage location =
          LocationMessage.builder().coordinates(-23.5505, -46.6333).name("São Paulo").build();
  ...
  class ValidationTests {
    ...
    void rejectsLatitudeTooHigh() {
      ...
      assertTrue(violations.stream().anyMatch(v -> v.getMessage().contains("90")));
    }
  ...
  class EdgeCasesTests {
    ...
    void handlesUnicodeName() {
      LocationMessage location = new LocationMessage(0.0, 0.0, "北京 Beijing مسجد", null);
    ...
    void handlesPreciseCoordinates() {
      LocationMessage location = new LocationMessage(-23.550520123456789, -46.633308987654321);
    ...
    void handlesNearPoles() {
      ...
      Set<ConstraintViolation<LocationMessage>> violationsNorth = validator.validate(northPole);
      Set<ConstraintViolation<LocationMessage>> violationsSouth = validator.validate(southPole);
    ...
    void handlesNearDateLine() {
      ...
      Set<ConstraintViolation<LocationMessage>> violationsEast = validator.validate(east);
      Set<ConstraintViolation<LocationMessage>> violationsWest = validator.validate(west);
