...
class InteractiveMessageTest {
    ...
    class ButtonMessageTests {
        ...
        void createsWithRequiredFields() {
            ButtonMessage message = new ButtonMessage(
                    "Choose an option:",
                    List.of(new ReplyButton("opt1", "Option 1")));
        ...
        void createsWithHeaderAndFooter() {
            ButtonMessage message = new ButtonMessage(
                    "Body text",
                    List.of(new ReplyButton("btn1", "Button 1")),
                    "Header",
                    "Footer");
        ...
        void validatesBodyNotBlank() {
            ButtonMessage message = new ButtonMessage(
                    "",
                    List.of(new ReplyButton("btn1", "Button")));
    ...
    class ListMessageTests {
        ...
        void createsWithSections() {
            ListSection section = new ListSection("Main", List.of(
                    new ListRow("item1", "Item 1", "Description 1")));
        ...
        void builderCreates() {
            ListMessage message = ListMessage.builder()
                    .body("Select a dish:")
                    .buttonText("View Menu")
                    .addSection("Appetizers", List.of(
                            new ListRow("app1", "Salad"),
                            new ListRow("app2", "Soup")))
                    .addSection("Main Courses", List.of(
                            new ListRow("main1", "Pasta"),
                            new ListRow("main2", "Pizza")))
                    .build();
        ...
        void typeReturnsInteractiveList() {
            ListMessage message = new ListMessage(
                    "Body",
                    "Button",
                    List.of(new ListSection(List.of(new ListRow("r1", "Row")))));
    ...
    class CtaUrlMessageTests {
        ...
        void createsCta() {
            CtaUrlMessage message = new CtaUrlMessage(
    ...
    class ListSectionTests {
        ...
        void createsWithTitle() {
            ListSection section = new ListSection("Category", List.of(
                    new ListRow("item1", "Item 1")));
        ...
        void createsWithoutTitle() {
            ListSection section = new ListSection(List.of(
                    new ListRow("item1", "Item 1")));
        ...
        void validatesTitleLength() {
            ...
            ListSection section = new ListSection(longTitle, List.of(
                    new ListRow("item1", "Item")));
    ...
    class RealWorldScenariosTests {
        ...
        void restaurantMenu() {
            ...
            Set<ConstraintViolation<ListMessage>> violations = validator.validate(message);
            assertTrue(violations.isEmpty());
            assertEquals(4, message.sections().stream()
                    .mapToInt(s -> s.rows().size()).sum());
        }
