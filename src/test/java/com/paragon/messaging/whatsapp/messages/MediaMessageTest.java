    ...
    class ImageMessageTests {
        ...
        void createsWithCaption() {
            Image image = new Image(
                    new MediaSource.MediaId("img123"),
                    "Beautiful sunset");
        ...
        void createsWithUrl() {
            Image image = new Image(
                    new MediaSource.Url("https://example.com/image.jpg"));
    ...
    class VideoMessageTests {
        ...
        void createsWithCaption() {
            Video video = new Video(
                    new MediaSource.MediaId("vid123"),
                    "Funny video");
    ...
    class AudioMessageTests {
        ...
        void createsWithUrl() {
            Audio audio = new Audio(
                    new MediaSource.Url("https://example.com/audio.mp3"));
    ...
    class DocumentMessageTests {
        ...
        void createsWithFilename() {
            Document document = new Document(
                    new MediaSource.MediaId("doc123"),
                    "report.pdf");
