...
class WhatsAppMessageSerializerTest {
    ...
    class MediaMessageSerializationTests {
        ...
        void serializeVideo() {
            MediaMessage.Video video = new MediaMessage.Video(
                    new MediaMessage.MediaSource.MediaId("video123"),
                    "Funny video");
        ...
        void serializeDocument() {
            MediaMessage.Document document = new MediaMessage.Document(
                    new MediaMessage.MediaSource.MediaId("doc123"),
                    "report.pdf",
                    "Q4 Report");
    ...
    class InteractiveMessageSerializationTests {
        ...
        void serializeButtonMessage() {
            InteractiveMessage.ButtonMessage buttonMsg = InteractiveMessage.ButtonMessage.builder()
        ...
        void serializeListMessage() {
            InteractiveMessage.ListMessage listMsg = InteractiveMessage.ListMessage.builder()
        ...
        void serializeCtaUrlMessage() {
            InteractiveMessage.CtaUrlMessage ctaMsg = InteractiveMessage.CtaUrlMessage.builder()
    ...
    class LocationMessageSerializationTests {
        ...
        void serializeLocationMessage() {
            LocationMessage location = new LocationMessage(
                    -23.5505, -46.6333, "São Paulo", "City center");
