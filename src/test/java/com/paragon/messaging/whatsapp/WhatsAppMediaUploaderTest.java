...
class WhatsAppMediaUploaderTest {
  ...
  private WhatsAppMediaUploader createUploader() {
    ...
    return new WhatsAppMediaUploader("test-phone-id", "test-access-token", httpClient);
  }
  ...
  class ConstructionTests {
    ...
    void createsWithValidParams() {
      WhatsAppMediaUploader uploader =
          new WhatsAppMediaUploader("phone123", "token456", httpClient);
    ...
    void rejectsNullPhoneId() {
      assertThrows(
          NullPointerException.class, () -> new WhatsAppMediaUploader(null, "token", httpClient));
    }
    ...
    void rejectsNullToken() {
      assertThrows(
          NullPointerException.class, () -> new WhatsAppMediaUploader("phone", null, httpClient));
    }
    ...
    void rejectsNullClient() {
      assertThrows(
          NullPointerException.class, () -> new WhatsAppMediaUploader("phone", "token", null));
    }
  }
  ...
  class UploadAudioTests {
    ...
    void rejectsNullBytes() {
      ...
      assertThrows(NullPointerException.class, () -> uploader.uploadAudio(null, "audio/ogg"));
    }
    ...
    void rejectsNullMimeType() {
      ...
      assertThrows(NullPointerException.class, () -> uploader.uploadAudio(audio, null));
    }
    ...
    void rejectsTooLarge() {
      ...
      MediaUploadException exception =
          assertThrows(
              MediaUploadException.class, () -> uploader.uploadAudio(largeAudio, "audio/ogg"));
  ...
  class UploadImageTests {
    ...
    void rejectsNullBytes() {
      ...
      assertThrows(NullPointerException.class, () -> uploader.uploadImage(null, "image/jpeg"));
    }
    ...
    void rejectsNullMimeType() {
      ...
      assertThrows(NullPointerException.class, () -> uploader.uploadImage(image, null));
    }
    ...
    void rejectsTooLarge() {
      ...
      MediaUploadException exception =
          assertThrows(
              MediaUploadException.class, () -> uploader.uploadImage(largeImage, "image/jpeg"));
  ...
  class ConstantsTests {
    ...
    void enforcesSizeLimits() {
      ...
      assertThrows(MediaUploadException.class, () -> uploader.uploadAudio(audio17MB, "audio/ogg"));

      // Image: 5MB limit
      byte[] image6MB = new byte[6 * 1024 * 1024];
      assertThrows(MediaUploadException.class, () -> uploader.uploadImage(image6MB, "image/jpeg"));
    }
  }
}
