...
class WhatsAppMessagingProviderTest {
  ...
  class ConfigurationTests {
    ...
    void constructor_validatesConfig() {
      assertThrows(Exception.class, () -> new WhatsAppMessagingProvider(null));
    }
  }
    ...
    void sendMessage_imageMessage() throws Exception {
      ...
      MediaMessage.Image image =
          new MediaMessage.Image(
              new MediaMessage.MediaSource.MediaId("media123"), "Beautiful photo");
      Recipient recipient = Recipient.ofPhoneNumber("5511999999999");
  ...
  class ErrorHandlingTests {
    ...
    void handles400Error() throws Exception {
      ...
      assertTrue(
          response.error().contains("Invalid recipient") || response.error().contains("400"));
    }
  ...
  class InputValidationTests {
    ...
    void validates_recipientNotNull() {
      ...
      assertThrows(Exception.class, () -> provider.sendMessage(null, message));
    }
    ...
    void validates_messageNotNull() {
      ...
      assertThrows(Exception.class, () -> provider.sendMessage(recipient, null));
    }
    ...
    void validates_textBodyNotBlank() throws Exception {
      ...
      assertThrows(Exception.class, () -> provider.sendMessage(recipient, message));
    }
  }
  ...
  class EdgeCasesTests {
    ...
    void handlesEmptyMessageId() throws Exception {
      mockServer.enqueue(
          new MockResponse().setResponseCode(200).setBody("{\"messages\":[{\"id\":\"\"}]}"));
