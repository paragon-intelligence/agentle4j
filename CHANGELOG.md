...
- **`JacksonJsonSchemaProducer` OpenAI strict mode compliance**: schemas with nested types now inline all `$ref`
...
feat new method outputOrThrow.

## [0.8.6] - 2026-03-08

### Fixed

fix routing to fallback

## [0.8.5] - 2026-03-08

### Fixed

- fix yaml desserialization error
