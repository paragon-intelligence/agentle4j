...
| Name | Description |
|------|-------------|
| [`FilesystemSkillProvider`](filesystemskillprovider.md) | Loads skills from the filesystem in SKILL |
| [`InMemorySkillProvider`](inmemoryskillprovider.md) | Stores code-defined skills in memory |
...
| Name | Description |
|------|-------------|
| [`SkillProvider`](skillprovider.md) | Provider interface for loading skills from various sources |
